...
\begin{enumerate}
	\item The two interlocutors (Alice and Bob) chose the common elliptic curve $E: y^2 = x^3 + ax+ b \mod p$ and the common primitive element $P = (X_p, Y_p)$
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{ECDH.png}
