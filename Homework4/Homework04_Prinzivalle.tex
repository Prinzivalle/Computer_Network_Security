 	...
 	\begin{subfigure}{.49\textwidth}
 		...
 		\begin{tikzpicture}[]
 			\begin{axis}[
 				...
 				\addplot [mark=none, domain=3:4, red, dashed] {sqrt(x^3-3*x+3)};
 				\addplot [mark=none, domain=3:4, red, dashed] {-sqrt(x^3-3*x+3)};
 				\addplot [only marks,mark=*,color=blue] coordinates { (-1.5,{sqrt(4.125)})};
 				\node[label={90:{(P)}},circle,fill,inner sep=2pt] at (axis cs:-1.5,2.03) {};
 				\addplot [only marks,mark=*,color=blue] coordinates { (2,{-sqrt(5)})};
 				\node[label={0:{(Q)}},circle,fill,inner sep=2pt] at (axis cs:2,{-sqrt(5)}) {};
 				\addplot [blue, domain=-3:3] {-1.2*x+0.2};
 				\addplot [only marks,mark=+,color=blue,mark size=5] coordinates { (1,{-sqrt(1)})};
