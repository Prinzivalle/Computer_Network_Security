...
\begin{figure}
	...
	\begin{tikzpicture}[
		...
		%VERTICAL LINES
		\draw [very thick] (CA)--++(0,-15);
		\node[mark size=3pt,color=black] at (0,-15) {\pgfuseplotmark{*}};
		\draw [very thick] (A)--++(0,-15);
		\node[mark size=3pt,color=black] at (\nodeTextWidth+1mm,-15) {\pgfuseplotmark{*}};
		\draw [very thick] (B)--++(0,-15);
		\node[mark size=3pt,color=black] at (\nodeTextWidth*2+2mm,-15) {\pgfuseplotmark{*}};
		...
		%\node[(BL8) (UPL9aux) (text8), draw, thick, label={[font=\itshape, fill=white, draw, anchor=center]90:Third Phase}] {};
